...
class SellerRepository extends dbOperation_1.DBOperation {
    ...
    updateProfile(input) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryString = "UPDATE users SET first_name=$1, lastname=$2, phone=$3, user_type=$4 WHERE user_id=$5 RETURNING *";
            const values = [
                input.firstName,
                input.lastName,
                input.phoneNumber,
    ...
    updateAddress(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const addressResult = yield this.executeQuery(addressQuery, [
                input.user_id,
            ]);
